...
if ($methodId == 35) { // Cryptomus ki ID yahan likhein
    $merchantId = htmlspecialchars($_POST["merchantId"]);
...
if ($methodId == 82) {
    $merchant_id = htmlspecialchars($_POST["merchant_id"]);
    $api_key = htmlspecialchars($_POST["api_key"]);
    $decryption_key = htmlspecialchars($_POST["decryption_key"]);
    $store_name = htmlspecialchars($_POST["store_name"]);
    $merchant_email = htmlspecialchars($_POST["merchant_email"]);
    $methodExtras = array(
        "merchant_id" => $merchant_id,
        "api_key" => $api_key,
...
if ($methodId == 113) {
    $binanceWallet= htmlspecialchars($_POST["wallet_address"]);
     
    $methodExtras = [
        "wallet_address" => $binanceWallet
    ];
}
if ($methodId == 114) {
    $merchantId = htmlspecialchars($_POST["merchant_id"]);
    $apiKey = htmlspecialchars($_POST["api_key"]);
    $secretKey = htmlspecialchars($_POST["secret_key"]);
