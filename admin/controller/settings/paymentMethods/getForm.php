...
// Cryptomus Gateway Code
if ($method["methodId"] == 35) {
    $form .= '<div class="form-group mb-3"><label class="form-label">Merchant ID</label>
    <input type="text" name="merchant_id" class="form-control" value="' . $methodExtras["merchant_id"] . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">Payment API Key</label>
    <input type="text" name="api_key" class="form-control" value="' . $methodExtras["api_key"] . '"/></div>';
}
if ($method["methodId"] == 82) {
    $form .= '<div class="form-group mb-3"><label class="form-label">AssanPay Merchant ID</label>
    <input type="text" name="merchant_id" class="form-control" value="' . $methodExtras["merchant_id"] . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">API Key</label>
    <input type="text" name="api_key" class="form-control" value="' . $methodExtras["api_key"] . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">Decryption Key</label>
    <input type="text" name="decryption_key" class="form-control" value="' . $methodExtras["decryption_key"] . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">Store/Panel Name</label>
    <input type="text" name="store_name" class="form-control" value="' . (isset($methodExtras["store_name"]) ? $methodExtras["store_name"] : '') . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">Merchant Email</label>
    <input type="email" name="merchant_email" class="form-control" value="' . (isset($methodExtras["merchant_email"]) ? $methodExtras["merchant_email"] : '') . '"/></div>';
}
...
if ($method["methodId"] == 110) {
    $form .= '<div class="form-group mb-3"><label class="form-label">Secret Key</label>
    <input type="text"  name="key" class="form-control" value="' . $methodExtras["key"] . '"/></div>';
...
if ($method["methodId"] == 113) {
    ...
    <input type="text"  name="key" class="form-control" value="' . $methodExtras["wallet_address"] . '"/></div>';
   
}
if ($method["methodId"] == 114) {
    $form .= '<div class="form-group mb-3">
        <label class="form-label">Secret Key</label>
        <input type="text" name="secret_key" class="form-control" value="' . $methodExtras["secret_key"] . '">
    </div>';
    
    $form .= '<div class="form-group mb-3">
        <label class="form-label">API Key</label>
        <input type="text" name="api_key" class="form-control" value="' . $methodExtras["api_key"] . '">
    </div>';
    
    $form .= '<div class="form-group mb-3">
        <label class="form-label">Merchant ID</label>
        <input type="text" name="merchant_id" class="form-control" value="' . $methodExtras["merchant_id"] . '">
    </div>';
}
