            ...
            <!-- foreach başlangıç -->
              <?php foreach( $other as $int ){ ?>
				...
				<tr class="settings-emails__row settings-emails__row-disable">
                  ...
                  <td class="settings-emails__td-actions">
                     <a class="btn btn-xs btn-default activate-integration" href="/admin/appearance/integrations/enabledg/<?=$int['id']?>">
                       Activate
                     </a>
                  </td>
               </tr>
				...
				<?php }else{ ?>
                  ...
                  <td class="settings-emails__td-actions">
                     <a class="btn btn-xs btn-default activate-integration" href="/admin/appearance/integrations/enabled/<?=$int['id']?>">
                       Activate
                     </a>
                  </td>
               </tr>
