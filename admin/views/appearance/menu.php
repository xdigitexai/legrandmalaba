...
<a data-toggle="modal" data-target="#modalDiv" data-action="add_external" data-id="<?php echo $menu["id"]; ?>"  class="btn btn-primary m-b add-modal-menu w-100">Add menu item</a>
             </div>      
</div>   
...
<a data-toggle="modal" data-target="#modalDiv" data-action="add_internal" data-id="<?php echo $menu["id"]; ?>"  class="btn btn-primary m-b add-modal-menu w-100">Add menu item</a> 
</div>
