...
<div class="container-fluid">
  <div class="row">    
   ...
   <ul class="nav nav-tabs">
          ...
          <a href="<?php echo site_url("admin/broadcasts/create") ?>" <button type="button" class="btn btn-primary w2-100" data-toggle="modal" data-target="" data-action="">Create Notifications </button> </a>
