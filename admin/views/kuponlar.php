...
<div class="container-fluid">
  <div class="row">    
   ...
   <ul class="nav nav-tabs">
      <li class="p-b"><button type="button" class="btn btn-primary w2-100" data-toggle="modal" data-target="#modalDiv" data-action="yeni_kupon">Create Coupon</button></li>
        ...
        <tbody>
          <?php foreach($kuponlar as $kupon ): ?>
              <tr>
                 ...
                 <td><input type="hidden" name="kupon_id" value="<?php echo $kupon["id"] ?>"><button type="submit" class="btn btn-default btn-xs dropdown-toggle btn-xs-caret btn-danger">Delete</button></td>
