...
<style>.fsb-select{display:none !important;}.fsb-original-select{margin: 0px !important;padding: 0px !important;border:none !important;}</style>
...
<li class="pull-right">
       ...
       <?php if( $action == "profit" || $action == "orders" ): ?>
         <li class="pull-right" style="max-width:100%">
