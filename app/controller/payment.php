...
if ($callbackSlug == "xendit") {
        require("payment/xendit.php");
        exit;
    }
    if ($callbackSlug == "paymongo") {
        require("payment/paymongo.php");
        exit;
    }
    ...
    if ($callbackSlug == "binance2") {
        require("payment/binance2.php");
        exit;
    }
    if ($callbackSlug == "binancepay") {
        require("payment/binancepay.php");
        exit;
    }
    if ($callbackSlug == "assanpay") {
    require("payment/assanpay.php");
    exit;
}
} else {
    errorExit("Invalid payment method callback.");
