...
class Alipay {
	...
	*/
	public function __construct($partnerId,$privateKey)
	{
		...
		{
			$this->_partner_id = $partnerId; // replace with your production partner ID
			$this->_key = $privateKey; // replace with your production private key
	...
	* @return string
	*/
	private function _send($data, $method = "GET")
	{
